// ============================================================
// Agendity — Demo mode entry point
// ============================================================
...
export function setupDemoMode(): void {
  ...
  if (typeof document !== 'undefined') {
    ...
    document.cookie = `agendity-auth=${cookieVal};path=/;max-age=${60 * 60 * 24 * 30};samesite=lax`;
  }

  console.warn(
    '%c[DEMO MODE] Agendity está en modo demostración. Ninguna solicitud sale del navegador.',
