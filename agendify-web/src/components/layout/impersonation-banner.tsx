...
export function ImpersonationBanner() {
  ...
  return (
    <div className="fixed left-0 right-0 top-0 z-50 flex items-center justify-center gap-3 bg-amber-400 px-4 py-2 text-sm font-medium text-amber-900 shadow-md">
