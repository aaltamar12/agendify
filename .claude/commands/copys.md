...
- **Español neutro latinoamericano** — cálido, sin regionalismos extremos
- **Tuteo** — usamos "tú" no "usted" (excepto en documentos legales)

## Qué puedes escribir

### App / Plataforma
- Textos de interfaz (botones, labels, placeholders, tooltips)
...
### Comunicaciones
- Emails transaccionales (bienvenida, confirmación de reserva, recordatorio)
- Mensajes de WhatsApp (confirmación, recordatorio, cancelación)
- Notificaciones push

### Marketing
- Textos para redes sociales
- Descripciones para App Store / Play Store (futuro)
