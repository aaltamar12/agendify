...
Rails.application.configure do
  ...
  # IMPORTANT: Nginx terminates SSL and forwards plain HTTP to Puma.
  # force_ssl would cause infinite redirect loops. HSTS is set by Nginx instead.
  ...
  config.hosts = [
    "api.agendity.co",
    "localhost"         # Allow Docker-internal healthchecks
  ]
