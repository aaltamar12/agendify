# Sprints — Agendity Feature Tracking
...
```
Sprint 2.2 (precios) → Sprint 6.2 (notificación cambio precio)
Sprint 3.3 (T&C páginas) → Sprint 6.3 (contenido legal completo)
Sprint 3.4 (Bre-B referido) → Sprint 3.5 (unificar admin)
Sprint 4.3 (rating page) → Sprint 4.4 (scores profesional)
Sprint 4.1 (reminder 30min) complementa Sprint 4.2 (countdown)
```
